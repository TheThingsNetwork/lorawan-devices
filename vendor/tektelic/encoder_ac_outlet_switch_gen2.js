function Encoder(data) {
  ...
  check_encode(
    'energy_consumption_push_button',
    function (value) {},
    function () {
  ...
  check_encode(
    'energy_consumption_reset_button',
    function (value) {},
    function () {
  ...
  check_encode(
    'energy_consumption_status_button',
    function (value) {},
    function () {
  ...
  check_encode(
    ...
    function (value) {
      ...
      var converted = [0x11 | 0x80, (value.lora_class & 0xf) << 4, ((value.confirm_mode & 0x1) << 0) | ((value.sync_word & 0x1) << 1) | ((value.duty_cycle & 0x1) << 2) | ((value.adr & 0x1) << 3)];
      ret = ret.concat(converted);
    },
    function () {
      ret = ret.concat([0x11]);
