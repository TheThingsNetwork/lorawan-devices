        ...
        decoder = [
            {
                key: [0x00, 0xBA],
                fn: function (arg) {
                    decoded_data['battery1_status.life'] = 2.5 + decode_field(arg, 0, 6, "unsigned") * 0.01;
                    decoded_data['battery1_status.eos_alert'] = decode_field(arg, 7, 7, "unsigned");
                    return 1;
                }
            },
            {
                key: [0x01, 0xBA],
                fn: function (arg) {
                    decoded_data['battery2_status.life'] = 2.5 + decode_field(arg, 0, 6, "unsigned") * 0.01;
                    decoded_data['battery2_status.eos_alert'] = decode_field(arg, 7, 7, "unsigned");
                    return 1;
                }
            },
            {
                key: [0x02, 0xBA],
                fn: function (arg) {
                    decoded_data['battery3_status.life'] = 2.5 + decode_field(arg, 0, 6, "unsigned") * 0.01;
                    decoded_data['battery3_status.eos_alert'] = decode_field(arg, 7, 7, "unsigned");
                    return 1;
                }
            },
            {
                key: [0x00, 0x85],
                fn: function (arg) {
                    decoded_data['timestamp.year'] = decode_field(arg, 0, 15, "unsigned");
                    decoded_data['timestamp.month'] = decode_field(arg, 16, 23, "unsigned");
                    decoded_data['timestamp.day'] = decode_field(arg, 24, 31, "unsigned");
                    decoded_data['timestamp.hour'] = decode_field(arg, 32, 39, "unsigned");
                    decoded_data['timestamp.minute'] = decode_field(arg, 40, 47, "unsigned");
                    decoded_data['timestamp.second'] = decode_field(arg, 48, 55, "unsigned");
                    return 7;
                }
            },
            {
                key: [0x00, 0x88],
                fn: function (arg) {
                    decoded_data['coordinate.latitude'] = decode_field(arg, 0, 23, "signed") * 0.0000125;
                    decoded_data['coordinate.longitude'] = decode_field(arg, 24, 55, "signed") * 0.0000001;
                    decoded_data['coordinate.altitude'] = decode_field(arg, 56, 71, "signed") * 0.5;
                    return 9;
                }
            },
            {
                key: [0x00, 0x92],
                fn: function (arg) {
                    ground_speed = decode_field(arg, 0, 15, "unsigned") * 0.1
            ...
            },
            {
                key: [0x00, 0x06],
                fn: function (arg) {
                    decoded_data['fix_status.time'] = decode_field(arg, 0, 0, "unsigned");
                    decoded_data['fix_status.position'] = decode_field(arg, 1, 1, "unsigned");
                    return 1;
                }
            },
            {
                key: [0x01, 0x06],
                fn: function (arg) {
                    decoded_data['geofence_status.one'] = decode_field(arg, 4, 7, "unsigned");
                    decoded_data['geofence_status.two'] = decode_field(arg, 0, 3, "unsigned");
                    decoded_data['geofence_status.three'] = decode_field(arg, 12, 15, "unsigned");
                    decoded_data['geofence_status.four'] = decode_field(arg, 8, 11, "unsigned");
                    return 2;
                }
            },
            {
            ...
            },
            {
                key: [0x00, 0x71],
                fn: function (arg) {
                    decoded_data['acceleration.xaxis'] = Number(decode_field(arg, 0, 15, "signed") * 0.001).toFixed(3);
                    decoded_data['acceleration.yaxis'] = Number(decode_field(arg, 16, 31, "signed") * 0.001).toFixed(3);
                    decoded_data['acceleration.zaxis'] = Number(decode_field(arg, 32, 47, "signed") * 0.001).toFixed(3);
                    return 6;
                }
            },
        ]
    ...
    if (port === 100) {
        decoder = [
            ...
            },
            {
                key: [0x31],
                fn: function (arg) {
                    decoded_data['speed_threshold.mobility'] = decode_field(arg, 0, 7, "unsigned") * 0.1;
                    decoded_data['speed_threshold.stillness'] = decode_field(arg, 8, 15, "unsigned") * 0.1;
                    return 2;
                }
            },
            {
                key: [0x32],
                fn: function (arg) {
                    decoded_data['average_speed_count.mobility'] = decode_field(arg, 4, 7, "unsigned");
                    decoded_data['average_speed_count.stillness'] = decode_field(arg, 0, 3, "unsigned");
                    return 1;
                }
            },
            {
                key: [0x33],
                fn: function (arg) {
                    decoded_data['tx.utc_report_enabled'] = decode_field(arg, 0, 0, "unsigned");
                    decoded_data['tx.coordinate_report_enabled'] = decode_field(arg, 1, 1, "unsigned");
                    decoded_data['tx.fsm_report_enabled'] = decode_field(arg, 2, 2, "unsigned");
                    return 1;
                }
            },
            {
                key: [0x34],
                fn: function (arg) {
                    decoded_data['geofence_definition1.latitude'] = decode_field(arg, 0, 23, "unsigned") * 0.0000125;
                    decoded_data['geofence_definition1.longitude'] = decode_field(arg, 24, 47, "unsigned") * 0.000025;
                    decoded_data['geofence_definition1.radius'] = decode_field(arg, 48, 63, "unsigned") * 10;
                    return 8;
                }
            },
            {
                key: [0x35],
                fn: function (arg) {
                    decoded_data['geofence_definition2.latitude'] = decode_field(arg, 0, 23, "unsigned") * 0.0000125;
                    decoded_data['geofence_definition2.longitude'] = decode_field(arg, 24, 47, "unsigned") * 0.000025;
                    decoded_data['geofence_definition2.radius'] = decode_field(arg, 48, 63, "unsigned") * 10;
                    return 8;
                }
            },
            {
                key: [0x36],
                fn: function (arg) {
                    decoded_data['geofence_definition3.latitude'] = decode_field(arg, 0, 23, "unsigned") * 0.0000125;
                    decoded_data['geofence_definition3.longitude'] = decode_field(arg, 24, 47, "unsigned") * 0.000025;
                    decoded_data['geofence_definition3.radius'] = decode_field(arg, 48, 63, "unsigned") * 10;
                    return 8;
                }
            },
            {
                key: [0x37],
                fn: function (arg) {
                    decoded_data['geofence_definition4.latitude'] = decode_field(arg, 0, 23, "unsigned") * 0.0000125;
                    decoded_data['geofence_definition4.longitude'] = decode_field(arg, 24, 47, "unsigned") * 0.000025;
                    decoded_data['geofence_definition4.radius'] = decode_field(arg, 48, 63, "unsigned") * 10;
                    return 8;
                }
            },
            {
            ...
            },
            {
                ...
                fn: function (arg) {
                    //}
                    decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = decode_field(arg, 0, 2, "unsigned") * 1;
                    switch (decoded_data['decoded_data.sensitivity.accelerometer_sample_rate']) {
                        case 1:
                            decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = 1;
                            break;
                        case 2:
                            decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = 10;
                            break;
                        case 3:
                            decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = 25;
                            break;
                        case 4:
                            decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = 50;
                            break;
                        case 5:
                            decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = 100;
                            break;
                        case 6:
                            decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = 200;
                            break;
                        case 7:
                            decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = 400;
                            break;
                        default: // invalid value
                            decoded_data['decoded_data.sensitivity.accelerometer_sample_rate'] = 0;
                            break;
                    }

                    decoded_data['decoded_data.sensitivity.accelerometer_measurement_range'] = decode_field(arg, 4, 5, "unsigned") * 1;
                    switch (decoded_data['decoded_data.sensitivity.accelerometer_measurement_range']) {
                        case 0:
                            decoded_data['decoded_data.sensitivity.accelerometer_measurement_range'] = 2;
                            break;
                        case 1:
                            decoded_data['decoded_data.sensitivity.accelerometer_measurement_range'] = 4;
                            break;
                        case 2:
                            decoded_data['decoded_data.sensitivity.accelerometer_measurement_range'] = 8;
                            break;
                        case 3:
                            decoded_data['decoded_data.sensitivity.accelerometer_measurement_range'] = 16;
                            break;
                        default:
                            decoded_data['decoded_data.sensitivity.accelerometer_measurement_range'] = 0;
                    }
                    return 1;
                }
            },
