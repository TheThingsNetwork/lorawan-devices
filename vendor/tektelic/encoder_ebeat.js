var sensor = 
{
  ...
  "temperature_humidity_analogIn": {
    "ambient_temp_rh_sample": {
      ...
      "or_80_to_write": "1",
      "port": "100",
      "onboard_temp/rh_sample_period_idle": {
        "data_size": "4",
        "bit_start": "31",
        "bit_end": "0",
        "type": "unsigned",
      ...
      "onboard_temp/rh_sample_period_active": {
        "data_size": "4",
        "bit_start": "31",
        "bit_end": "0",
        "type": "unsigned",
  ...
  "command_control_register": {
    ...
    "configurationn_factory_factory_reset": {
      "header": "0x72",
      "or_80_to_write": "1",
      "port": "100",
