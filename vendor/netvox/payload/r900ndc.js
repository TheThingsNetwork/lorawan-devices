...
function decodeUplink(input) {
  ...
  switch (input.fPort) {
    case 22:
		...
		data.LowCurrent1Alarm = input.bytes[11] & 1;
		data.HighCurrent1Alarm = input.bytes[11]>>1 & 1;
		data.LowCurrent2Alarm = input.bytes[11]>>2 & 1;
		data.HighCurrent2Alarm = input.bytes[11]>>3 & 1;
