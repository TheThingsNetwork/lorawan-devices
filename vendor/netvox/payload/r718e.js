...
function getCmdToID(cmdtype) {
  ...
  else if (cmdtype == 'SetRestoreReportReq') return 7;
  else if (cmdtype == 'SetRestoreReportRsp') return 135;
  else if (cmdtype == 'GetRestoreReportReq') return 8;
  else if (cmdtype == 'GetRestoreReportRsp') return 136;
}

function getDeviceID(devName) {
  if (devName == 'R718E') return 28;
}
