...
function getCmdToID(cmdtype) {
  if (cmdtype == 'ConfigReportReq' || cmdtype == 'SetButtonPressTimeReq') return 1;
  else if (cmdtype == 'ConfigReportRsp' || cmdtype == 'SetButtonPressTimeRsp') return 129;
  else if (cmdtype == 'ReadConfigReportReq' || cmdtype == 'GetButtonPressTimeReq') return 2;
  else if (cmdtype == 'ReadConfigReportRsp' || cmdtype == 'GetButtonPressTimeRsp') return 130;
}
...
function getDeviceID(devName) {
  if (devName == 'RB02I') return 16;
  else if (devName == 'R718T') return 49;
  else if (devName == 'R312A') return 77;
  else if (devName == 'R312') return 85;
}
...
function decodeUplink(input) {
  ...
  switch (input.fPort) {
    case 6:
      ...
      if (data.Device == 'R312') data.Doorbell = input.bytes[4];
      else data.Alarm = input.bytes[4];
