...
function getCmdToID(cmdtype) {
  ...
  else if (cmdtype == 'SetIRDisableTimeReq') return 3;
  else if (cmdtype == 'SetIRDisableTimeRsp') return 131;
  else if (cmdtype == 'GetIRDisableTimeReq') return 4;
  else if (cmdtype == 'GetIRDisableTimeRsp') return 132;
}

function getDeviceID(devName) {
  if (devName == 'RB11E') return 3;
}
...
function decodeUplink(input) {
  ...
  switch (input.fPort) {
    case 6:
      ...
      } else data.Temp = ((input.bytes[4] << 8) | input.bytes[5]) / 100;
