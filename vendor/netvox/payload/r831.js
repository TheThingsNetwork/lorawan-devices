...
function getCmdToID(cmdtype) {
  ...
  else if (cmdtype == 'SetSwitchTypeReq') return 3;
  else if (cmdtype == 'SetSwitchTypeRsp') return 131;
  else if (cmdtype == 'GetSwitchTypeReq') return 4;
  else if (cmdtype == 'GetSwitchTypeRsp') return 132;
  else if (cmdtype == 'Off') return 144;
  else if (cmdtype == 'On') return 145;
  else if (cmdtype == 'Toggle') return 146;
  else if (cmdtype == 'ReadCurrentStatus') return 148;
  else if (cmdtype == 'Stop') return 149;
}
...
function encodeDownlink(input) {
  ...
  if (input.data.Cmd == 'ConfigReportReq') {
    ...
    } else ret = ret.concat(getCmdID, devid, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
  ...
  switch (input.fPort) {
    case 7:
      ...
      if (input.bytes[0] === getCmdToID('ConfigReportReq')) {
        ...
        if (input.bytes[1] === 0xad || input.bytes[1] === 0xb0) data.Channel = padLeft(input.bytes[2].toString(2), 8);
