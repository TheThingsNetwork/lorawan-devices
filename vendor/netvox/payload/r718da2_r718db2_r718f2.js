...
function getDeviceType(devName) {
  if (devName == 'R718DA2') return 47;
  else if (devName == 'R718DB2') return 61;
  else if (devName == 'R718F2') return 62;
  else if (devName == 'R718J2') return 67;
  else if (devName == 'R718LB2') return 69;
  else if (devName == 'R311CA') return 76;
  else if (devName == 'R311CB') return 86;
  else if (devName == 'R730F2') return 126;
  else if (devName == 'R730DA2') return 138;
  else if (devName == 'R730DB2') return 140;
  else if (devName == 'R730LB2') return 142;
  else if (devName == 'R311CC') return 108;
}
