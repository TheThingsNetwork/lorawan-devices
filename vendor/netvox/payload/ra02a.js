...
function getCmdToID(cmdtype) {
  ...
  else if (cmdtype == 'SetAlarmThresholdReq') return 3;
  else if (cmdtype == 'SetAlarmThresholdRsp') return 131;
  else if (cmdtype == 'GetAlarmThresholdReq') return 4;
  else if (cmdtype == 'GetAlarmThresholdRsp') return 132;
}
  ...
  switch (input.fPort) {
    case 6:
      ...
      if (input.bytes[1] === 0x0a) {
        ...
        } else data.Temp = ((input.bytes[6] << 8) | input.bytes[7]) / 10;
