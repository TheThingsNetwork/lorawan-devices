...
function getCmdToID(cmdtype) {
  ...
  else if (cmdtype == 'SetFiltertimeReq') return 3;
  else if (cmdtype == 'SetFiltertimeRsp') return 131;
  else if (cmdtype == 'GetFiltertimeReq') return 4;
  else if (cmdtype == 'GetFiltertimeRsp') return 132;
  else if (cmdtype == 'SetPulseCounterClearModeReq') return 5;
  else if (cmdtype == 'SetPulseCounterClearModeRsp') return 133;
  else if (cmdtype == 'GetPulseCounterClearModeReq') return 6;
  else if (cmdtype == 'GetPulseCounterClearModeRsp') return 134;
}
...
function decodeUplink(input) {
  ...
  switch (input.fPort) {
    case 6:
      ...
      if (data.Device === 'R718H') data.PulseCount = (input.bytes[4] << 8) | input.bytes[5];
