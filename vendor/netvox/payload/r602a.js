...
function getCmdToID(cmdtype) {
  ...
  else if (cmdtype == 'StartWarningWithAckReq') return 3;
  else if (cmdtype == 'StartWarningWithAckRsp') return 131;
  else if (cmdtype == 'StartWarning') return 144;
}

function getDeviceID(devName) {
  if (devName == 'R602A') return 105;
}
