...
function getDeviceID(devName) {
  if (devName == 'RA0715' || devName == 'RA07Series') return 5;
  else if (devName == 'R726Series' || devName == 'R72615' || devName == 'R72615A') return 9;
  else if (devName == 'RA0715Y' || devName == 'RA07**YSeries') return 13;
  else if (devName == 'R718PA') return 87;
  else if (devName == 'R718PB') return 88;
}

function checkSensorExist(val) {
  if (val == 0xff || val == 0xffff || val == 0xffffffff) return -1;
  else return val;
}
