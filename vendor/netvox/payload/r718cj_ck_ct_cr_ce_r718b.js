...
function getCmdToID(cmdtype) {
  ...
  else if (cmdtype == 'SetGlobalCalibrateReq') return 1;
  else if (cmdtype == 'SetGlobalCalibrateRsp') return 129;
  else if (cmdtype == 'GetGlobalCalibrateReq') return 2;
  else if (cmdtype == 'GetGlobalCalibrateRsp') return 130;
  else if (cmdtype == 'ClearGlobalCalibrateReq') return 3;
  else if (cmdtype == 'ClearGlobalCalibrateRsp') return 131;
}

function getDeviceType(devName) {
  if (devName == 'R718CJ') return 144;
  else if (devName == 'R718CK') return 145;
  else if (devName == 'R718CT') return 146;
  else if (devName == 'R718CR') return 147;
  else if (devName == 'R718CE') return 148;
  else if (devName == 'R718B') return 149;
}
...
function getSensorTypeID(sensortype) {
  if (sensortype == 'Temperature') return 1;
}
...
function decodeUplink(input) {
  ...
  switch (input.fPort) {
    case 6:
      ...
      } else data.Temp = ((input.bytes[4] << 8) | input.bytes[5]) / 10;
    ...
    case 14:
      ...
      if (input.bytes[0] === 0x81) {
        ...
        } else data.DeltValue = (input.bytes[7] << 8) | input.bytes[8];
      } else if (input.bytes[0] === 0x83) data.Status = input.bytes[1] === 0x00 ? 'Success' : 'Failure';
