...
function getDeviceType(devName) {
  if (devName == 'R718DA') return 26;
  else if (devName == 'R718DB') return 27;
  else if (devName == 'R718J') return 33;
  else if (devName == 'R718LB') return 37;
  else if (devName == 'R718MBA') return 39;
  else if (devName == 'R311FA') return 79;
  else if (devName == 'R718Q') return 91;
  else if (devName == 'R730MBA') return 130;
  else if (devName == 'R730DA') return 137;
  else if (devName == 'R730DB') return 139;
  else if (devName == 'R730LB') return 141;
  else if (devName == 'R718QA') return 151;
  else if (devName == 'R311DA') return 168;
  else if (devName == 'R311DB') return 169;
  else if (devName == 'R720F') return 183;
}
