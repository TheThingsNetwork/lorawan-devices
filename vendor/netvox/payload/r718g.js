...
function getCmdToID(cmdtype) {
  ...
  else if (cmdtype == 'SetSunlightSampleRangeReq') return 3;
  else if (cmdtype == 'SetSunlightSampleRangeRsp') return 131;
  else if (cmdtype == 'GetSunlightSampleRangeReq') return 4;
  else if (cmdtype == 'GetSunlightSampleRangeRsp') return 132;
}
