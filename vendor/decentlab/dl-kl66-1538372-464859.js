  ...
  SENSORS: [
    {
      ...
      values: [
        ...
        },
        {
          ...
          displayName: 'Weight',
          convert: function (x) {
            return ((Math.pow((x[0] / x[1]) * 32768, 2) - Math.pow(this.PARAMETERS.f0, 2)) * this.PARAMETERS.k) / 1000000;
          },
          unit: 'g',
        },
        {
          ...
          convert: function (x) {
            return (((((Math.pow((x[0] / x[1]) * 32768, 2) - Math.pow(this.PARAMETERS.f0, 2)) * this.PARAMETERS.k) / 1000000) * -1.5) / 1000) * 9.8067;
          },
          unit: 'µm',
        },
        {
          ...
          displayName: 'Strain',
          convert: function (x) {
            return ((((((Math.pow((x[0] / x[1]) * 32768, 2) - Math.pow(this.PARAMETERS.f0, 2)) * this.PARAMETERS.k) / 1000000) * -1.5) / 1000) * 9.8067) / 0.066;
          },
          unit: 'µm⋅m⁻¹',
        },
      ],
