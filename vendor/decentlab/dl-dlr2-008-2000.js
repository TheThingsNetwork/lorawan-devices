      ...
      values: [
        {
          ...
          convert: function (x) {
            return (
              -244.83 +
              2.3419 * (((((x[0] + x[1] * 65536) / 8388608 - 1) / 2) * this.PARAMETERS.R) / (1 - ((x[0] + x[1] * 65536) / 8388608 - 1) / 2)) +
              0.0010664 * Math.pow(((((x[0] + x[1] * 65536) / 8388608 - 1) / 2) * this.PARAMETERS.R) / (1 - ((x[0] + x[1] * 65536) / 8388608 - 1) / 2), 2)
            );
          },
          unit: '°C',
        },
