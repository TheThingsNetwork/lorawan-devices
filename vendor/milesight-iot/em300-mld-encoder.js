 ...
 * @param {number} d2d_master_config.mode values: (3: leakage_status_alarm, 4: leakage_status_alarm_release)
...
function setD2DMasterConfig(d2d_master_config) {
    ...
    var mode_map = { 3: "leakage_status_alarm", 4: "leakage_status_alarm_release" };
