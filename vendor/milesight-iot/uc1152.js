    ...
    for (i = 0; i < bytes.length;) {
        ...
        // MODBUS
            ...
            switch (data_type) {
                case 0:
                    channel['index'] = chn;
                    channel['value'] = bytes[i] ? "on" : "off";
                    decoded.channels.push(channel);
                    i += 1;
                    break;
                case 1:
                    channel['index'] = chn;
                    channel['value'] = bytes[i];
                    decoded.channels.push(channel);
                    i += 1;
                    break;
                case 2:
                case 3:
                    channel['index'] = chn;
                    channel['value'] = readUInt16LE(bytes.slice(i, i+2));
                    decoded.channels.push(channel);
                    i += 2;
                    break;
                case 4:
                case 6:
                    channel['index'] = chn;
                    channel['value'] = readUInt32LE(bytes.slice(i, i + 4));
                    decoded.channels.push(channel);
                    i += 4;
                    break;
                case 5:
                case 7:
                    channel['index'] = chn;
                    channel['value'] = readFloatLE(bytes.slice(i, i + 4));
                    decoded.channels.push(channel);
                    i += 4;
                    break;
            }
