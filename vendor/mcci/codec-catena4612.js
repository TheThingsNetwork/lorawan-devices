...
Name:   catena-message-port2-port4-decoder-ttn.js

Function:
    Decode MCCI port 0x02 and 0x04 messages for TTN console.
...
function Decoder(bytes, port) {
  ...
  if (port === 2 || port === 4) {
    ...
    if (flags & 0x8) {
      ...
      var tHeatIndexF = CalculateHeatIndex(decoded.tempC * 1.8 + 32, decoded.rh);
      if (tHeatIndexF !== null) decoded.tHeatIndexC = (tHeatIndexF - 32) / 1.8;
    }
