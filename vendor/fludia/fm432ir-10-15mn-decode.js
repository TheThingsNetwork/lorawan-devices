const PAYLOAD_TYPE = {
  ...
  T1_E_SUM_ADJUSTABLE_STEP_WH           :  {header: 0x76, size_min: 13/*in bytes*/, size_max: 51/*in bytes*/, name: "T1_E_SUM_ADJUSTABLE_STEP_WH"},
  T1_E_POS_ADJUSTABLE_STEP_WH           :  {header: 0x77, size_min: 13/*in bytes*/, size_max: 51/*in bytes*/, name: "T1_E_POS_ADJUSTABLE_STEP_WH"},
  T1_E_NEG_ADJUSTABLE_STEP_WH           :  {header: 0x78, size_min: 13/*in bytes*/, size_max: 51/*in bytes*/, name: "T1_E_NEG_ADJUSTABLE_STEP_WH"},
  T1_IR_DOUBLE_MODE_ADJUSTABLE_STEP_WH  :  {header: 0x79, size_min: 23/*in bytes*/, size_max: 51/*in bytes*/, name: "T1_IR_DOUBLE_MODE_ADJUSTABLE_STEP_WH"},
