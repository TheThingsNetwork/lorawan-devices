  ...
  if (port === 125) {
    ...
    if (decodedBatch === false) {
      ...
      brData = brUncompress(
        3,
        [
          { taglbl: 0, resol: 1, sampletype: 7, lblname: 'MeanDifferentialPressureSinceLastReport', divide: 1 },
          { taglbl: 1, resol: 1, sampletype: 7, lblname: 'MinimalDifferentialPressureSinceLastReport', divide: 1 },
          { taglbl: 2, resol: 1, sampletype: 7, lblname: 'MaximalDifferentialPressureSinceLastReport', divide: 1 },
          ...
          { taglbl: 5, resol: 1, sampletype: 7, lblname: 'DifferentialPressure', divide: 1 },
