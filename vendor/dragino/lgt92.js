...
data.Roll=(bytes[11]<<24>>16 | bytes[12])/100;//roll,units: ° 
data.Pitch=(bytes[13]<<24>>16 | bytes[14])/100; //pitch,units: ° 
var hdop = 0;
if(bytes[15] > 0)
{
...
data.altitude =(bytes[16]<<24>>16 | bytes[17]) / 100; //Altitude,units: °
return {
data:data,
};
  default:
