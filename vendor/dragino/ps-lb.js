...
function decodeUplink(input) {
  ...
  switch (input.fPort) {
    case 5: {
      ...
      else if (bytes[3] == 0x0f) freq_band = 'AS923_4';
    ...
    default:
      {
        ...
        if (data.Probe_mod === 0x00) {
          if (data.IDC_intput_mA <= 4.0) data.Water_deep_cm = 0;
          else data.Water_deep_cm = parseFloat(((decode.IDC_intput_mA - 4.0) * ((bytes[3] * 100) / 16)).toFixed(3));
        } else if (data.Probe_mod == 0x01) {
          if (data.IDC_intput_mA <= 4.0) data.Water_pressure_MPa = 0;
          else if (bytes[3] == 1) data.Water_pressure_MPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 0.0375).toFixed(3));
          else if (bytes[3] == 2) data.Water_pressure_MPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 0.0625).toFixed(3));
          else if (bytes[3] == 3) data.Water_pressure_MPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 0.1).toFixed(3));
          else if (bytes[3] == 4) data.Water_pressure_MPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 0.15625).toFixed(3));
          else if (bytes[3] == 5) data.Water_pressure_MPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 0.625).toFixed(3));
          else if (bytes[3] == 6) data.Water_pressure_MPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 2.5).toFixed(3));
          else if (bytes[3] == 7) data.Water_pressure_MPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 3.75).toFixed(3));
          else if (bytes[3] == 8) data.Water_pressure_MPa = parseFloat(((decode.IDC_intput_mA - 4.0) * -0.00625).toFixed(3));
          else if (bytes[3] == 9) {
          ...
          } else if (bytes[3] == 10) data.Water_pressure_kPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 0.3125).toFixed(3));
          else if (bytes[3] == 11) data.Water_pressure_kPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 3.125).toFixed(3));
          else if (bytes[3] == 12) data.Water_pressure_kPa = parseFloat(((decode.IDC_intput_mA - 4.0) * 6.25).toFixed(3));
        }
      }
      return {
        data: data,
