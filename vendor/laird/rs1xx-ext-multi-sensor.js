...
function decodeDownlink(input) {
  ...
  switch (input.bytes[0]) {
    ...
    case 0x0a:
      ...
      break;
    case 0x0d:
      output = decodeDownlinkSetOpenClosedConfig(input);
      break;
    case 0x0f:
    case 0x10:
...
function encodeDownlink(input) {
  ...
  switch (input.data.msgType) {
    ...
    case 'asRequestBacklogLIFO':
      ...
      break;
    case 'asSetOpenClosedConfig':
      output = encodeDownlinkSetOpenClosedConfig(input);
      break;
...
function decodeUplink(input) {
  ...
  switch (input.bytes[0]) {
    ...
    case 0x7:
      ...
      break;
    case 0x8:
      output = decodeUplinkLairdMsgTypeContactSensorConfig(input.bytes);
      break;
    case 0x9:
      output = decodeUplinkLairdMsgTypeContactSensorState(input.bytes);
      break;
    case 0xa:
