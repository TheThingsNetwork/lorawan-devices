 ...
 *
 * Entry point for RTD type RS1XX sensors.
 *
...
var msgTypeDLEnum = new KeyValuePairList([
  new KeyValuePair('genericDataRetrieval', 0x01),
  new KeyValuePair('generateRTCDownlink', 0x02),
  new KeyValuePair('config', 0x03),
  new KeyValuePair('heaterControl', 0x04),
  new KeyValuePair('backoff', 0x05),
  new KeyValuePair('asRequestBacklogFIFO', 0x06),
  new KeyValuePair('asFormatFlash', 0x07),
  new KeyValuePair('asRequestBacklogLIFO', 0x0a),
  new KeyValuePair('asCancelBacklogRetrieval', 0x0b),
  new KeyValuePair('asSetOpenClosedConfig', 0x0d),
  new KeyValuePair('rtdConfig', 0x0e),
  new KeyValuePair('asRequestTargetedBacklogFIFO', 0x0f),
  new KeyValuePair('asRequestTargetedBacklogLIFO', 0x10),
]);
...
var monthTypeEnum = new KeyValuePairList([
  new KeyValuePair('January', 1),
  new KeyValuePair('February', 2),
  new KeyValuePair('March', 3),
  new KeyValuePair('April', 4),
  new KeyValuePair('May', 5),
  new KeyValuePair('June', 6),
  new KeyValuePair('July', 7),
  new KeyValuePair('August', 8),
  new KeyValuePair('September', 9),
  new KeyValuePair('October', 10),
  new KeyValuePair('November', 11),
  new KeyValuePair('December', 12),
]);

/******************************************************************************
 * Battery Type
 *****************************************************************************/
var batteryTypeEnum = new KeyValuePairList([new KeyValuePair('Alkaline', 1), new KeyValuePair('Lithium', 2)]);

/******************************************************************************
 * Open/Closed sensor Operating Mode
 *****************************************************************************/
var operatingModeEnum = new KeyValuePairList([new KeyValuePair('Door Sensor', 0), new KeyValuePair('Pushbutton', 1)]);

/******************************************************************************
 * Open/Closed sensor state
 *****************************************************************************/
var openClosedSensorStateEnum = new KeyValuePairList([new KeyValuePair('Closed', 0), new KeyValuePair('Open', 1)]);

/******************************************************************************
 * Downlink Options
 *****************************************************************************/
var downlinkOptionsEnum = new KeyValuePairList([
  new KeyValuePair('None', 0),
  new KeyValuePair('Send Simple Config', 1),
  new KeyValuePair('Send Advanced Config', 2),
  new KeyValuePair('Send Firmware Version', 3),
  new KeyValuePair('Send Open Closed Config', 4),
  new KeyValuePair('Send Battery Voltage', 5),
  new KeyValuePair('Reset Sensor', 6),
  new KeyValuePair('Start Advertising', 7),
  new KeyValuePair('Send RTD Config', 8),
]);

/******************************************************************************
 * Boolean
 *****************************************************************************/
var booleanEnum = new KeyValuePairList([new KeyValuePair('False', 0), new KeyValuePair('True', 1)]);

/******************************************************************************
 * Uplink Command IDs
 *****************************************************************************/
var msgTypeULEnum = new KeyValuePairList([
  new KeyValuePair('Laird_Internal_TH', 0x01),
  new KeyValuePair('Laird_Agg_TH', 0x2),
  new KeyValuePair('SendBackLogMessage', 0x3),
  new KeyValuePair('SendBackLogMessages', 0x4),
  new KeyValuePair('Laird_Simple_Config', 0x5),
  new KeyValuePair('Laird_Advanced_Config', 0x6),
  new KeyValuePair('Laird_FW_Version', 0x7),
  new KeyValuePair('Laird_Contact_Sensor_Config', 0x8),
  new KeyValuePair('Laird_Contact_Sensor', 0x9),
  new KeyValuePair('Laird_Battery_Voltage', 0xa),
  new KeyValuePair('Laird_RTD', 0xb),
  new KeyValuePair('Laird_RTD_Config', 0xc),
]);
...
var batteryCapacityEnum = new KeyValuePairList([
  new KeyValuePair('0-5%', 0),
  new KeyValuePair('5-20%', 1),
  new KeyValuePair('20-40%', 2),
  new KeyValuePair('40-60%', 3),
  new KeyValuePair('60-80%', 4),
  new KeyValuePair('80-100%', 5),
]);
 ...
 *****************************************************************************/
var loraIndicationOptionsBitfield = new KeyValuePairList([new KeyValuePair('Open', 1), new KeyValuePair('Closed', 2), new KeyValuePair('Resend', 4), new KeyValuePair('Cancel', 8)]);

/******************************************************************************
 * Uplink Message Options
 *****************************************************************************/
var uplinkOptionsBitfield = new KeyValuePairList([
  new KeyValuePair('Sensor request for server time', 0x1),
  new KeyValuePair('Sensor configuration error', 0x2),
  new KeyValuePair('Sensor alarm flag', 0x4),
  new KeyValuePair('Sensor reset flag', 0x8),
  new KeyValuePair('Sensor fault flag', 0x10),
]);
  ...
  if (decode == true) {
    if (data == 0) {
      ...
      while (data > 0 && itemFound == true) {
        index = 0;
        itemFound = false;
        while (itemIndex < bitfieldData.length && data > 0 && itemFound == false) {
          if ((data & bitfieldData.list[itemIndex].value) == bitfieldData.list[itemIndex].value) {
...
function twoBytesToFloat(stream) {
  ...
  var fractionalView = new DataView(new ArrayBuffer(1));
  var decimalView = new DataView(new ArrayBuffer(1));
...
function fourBytesToFloat(stream) {
  var result;
  var fractionalData = stream.slice(0, 2);
  var decimalData = stream.slice(2, 2 + 2);
  var fractionalView = new DataView(new ArrayBuffer(2));
  var decimalView = new DataView(new ArrayBuffer(2));
  var fractionalResult;
  var decimalResult;
...
function decodeDownlinkGenerateRTCDownlink(input) {
  ...
  // Month
  nextResult = getEnumValue(monthTypeEnum, true, input.bytes[index++]);
  if (nextResult != -1) {
    month = nextResult;
  } else {
...
function decodeDownlinkConfig(input) {
  ...
  // Battery Type
  nextResult = getEnumValue(batteryTypeEnum, true, input.bytes[index++]);
  if (nextResult != -1) {
  ...
  // Sensor Read Period
  sensorReadPeriod = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // Sensor Aggregate
  sensorAggregate = input.bytes[index++];
  // Temperature Alarms
  nextResult = getEnumValue(booleanEnum, true, input.bytes[index++]);
  if (nextResult != -1) {
  ...
  if (input.bytes[0] != 0x03) {
    tempAlarmLimitLow = twoBytesToInt16(input.bytes.slice(index, index + 2));
    index += 2;
  }
  // RTD High Temperature Alarm Limit
  if (input.bytes[0] != 0x03) {
    tempAlarmLimitHigh = twoBytesToInt16(input.bytes.slice(index, index + 2));
    index += 2;
  }
  ...
  // BLE LED
  ledBle = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // LORA LED
  ledLora = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // Build message
  if (errors.length != 0) {
    result = {
...
function decodeDownlinkHeaterControl(input) {
  ...
  // Heater Time
  heaterTime = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // Build message
  if (errors.length != 0) {
    result = {
...
function decodeDownlinkBackoff(input) {
  ...
  // Backoff Period
  backoffPeriod = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // Build message
  if (errors.length != 0) {
    result = {
...
function decodeDownlinkRequestBacklog(input) {
  ...
  backlogPullReqNum = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // Backlog Pull Request Period
  backlogPullReqPeriod = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // Build message
  if (errors.length != 0) {
    result = {
...
function decodeDownlinkSetOpenClosedConfig(input) {
  ...
  // Operating Mode
  nextResult = getEnumValue(operatingModeEnum, true, input.bytes[index++]);
  if (nextResult != -1) {
  ...
  nextResult = getBitfieldValue(loraIndicationOptionsBitfield, true, input.bytes[index++]);
  if (nextResult != -1) {
  ...
  // Open Dwell Time
  openDwellTime = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // Closed Dwell Time
  closedDwellTime = twoBytesToUInt16(input.bytes.slice(index, index + 2));
  index += 2;
  // Resend Interval
...
function encodeDownlinkConfig(input) {
  ...
  // Sensor Read Period
  if (input.data.sensorReadPeriod >= 30 && input.data.sensorReadPeriod <= 65535) {
  ...
  // Sensor Aggregate
  if (input.data.sensorAggregate >= 0 && input.data.sensorAggregate <= 10) {
  ...
  // Low Temperature Alarm Limit
  if (input.data.msgType == 'config') {
    if (input.data.tempAlarmLimitLow >= -40 && input.data.tempAlarmLimitLow <= 85) {
  ...
  // High Temperature Alarm Limit
  if (input.data.msgType == 'config') {
    if (input.data.tempAlarmLimitHigh >= -40 && input.data.tempAlarmLimitHigh <= 85) {
  ...
  // RTD Low Temperature Alarm Limit
  if (input.data.msgType != 'config') {
    if (input.data.tempAlarmLimitLow >= -200 && input.data.tempAlarmLimitLow <= 850) {
  ...
  // RTD High Temperature Alarm Limit
  if (input.data.msgType != 'config') {
    if (input.data.tempAlarmLimitHigh >= -250 && input.data.tempAlarmLimitHigh <= 850) {
  ...
  // Low Humidity Alarm Limit
  if (input.data.msgType == 'config') {
    if (input.data.humidityAlarmLimitLow >= 0 && input.data.humidityAlarmLimitLow <= 100) {
  ...
  // High Humidity Alarm Limit
  if (input.data.msgType == 'config') {
    if (input.data.humidityAlarmLimitHigh >= 0 && input.data.humidityAlarmLimitHigh <= 100) {
  ...
  // BLE LED
  if (input.data.ledBle >= 0 && input.data.ledBle <= 65535) {
  ...
  // LORA LED
  if (input.data.ledLora >= 0 && input.data.ledLora <= 65535) {
...
function encodeDownlinkHeaterControl(input) {
  ...
  // Heater Setting
  if (input.data.heaterSetting >= 0 && input.data.heaterSetting <= 15) {
    data[index++] = input.data.heaterSetting;
  } else {
    errors.push('Invalid Heater Setting used!');
  }
  // Heater Time
  if (input.data.heaterTime >= 0 && input.data.heaterTime <= 65535) {
...
function encodeDownlinkBackoff(input) {
  ...
  // Backoff Period
  if (input.data.backoffPeriod >= 0 && input.data.backoffPeriod <= 65535) {
...
function encodeDownlinkRequestBacklog(input) {
  ...
  // Backlog Pull Request Number
  if (input.data.backlogPullReqNum >= 0 && input.data.backlogPullReqNum <= 65535) {
  ...
  // Backlog Pull Request Period
  if (input.data.backlogPullReqPeriod >= 0 && input.data.backlogPullReqPeriod <= 65535) {
...
function encodeDownlinkSetOpenClosedConfig(input) {
  ...
  // Lora Notification Options
  nextResult = getBitfieldValue(loraIndicationOptionsBitfield, false, input.data.loraNotificationOptions);
  if (nextResult != 'Not Found') {
    data[index++] = nextResult;
  } else {
  ...
  // Open Dwell Time
  if (input.data.openDwellTime >= 5 && input.data.openDwellTime <= 1023) {
  ...
  // Closed Dwell Time
  if (input.data.closedDwellTime >= 5 && input.data.closedDwellTime <= 1023) {
  ...
  // Resend Interval
  if (input.data.resendInterval >= 1 && input.data.resendInterval <= 255) {
    data[index++] = input.data.resendInterval;
  } else {
    errors.push('Invalid Resend Interval used!');
  }
  // Debounce Adjust
  if (input.data.debounceAdjust >= 0 && input.data.debounceAdjust <= 255) {
...
function encodeDownlinkRequestTargetedBacklog(input) {
  ...
  if (input.data.startDay >= 1 && input.data.startDay <= dayMax) {
    data[index++] = input.data.startDay;
  } else {
    errors.push('Invalid day value used!');
  }
  // Start Hours
  if (input.data.startHours >= 0 && input.data.startHours <= 23) {
    data[index++] = input.data.startHours;
  } else {
    errors.push('Invalid hour value used!');
  }
  // Start Minutes
  if (input.data.startMinutes >= 0 && input.data.startMinutes <= 59) {
    data[index++] = input.data.startMinutes;
  } else {
    errors.push('Invalid minute value used!');
  }
  // Start Seconds
  if (input.data.startSeconds >= 0 && input.data.startSeconds <= 59) {
  ...
  if (input.data.endDay >= 1 && input.data.endDay <= dayMax) {
    data[index++] = input.data.endDay;
  } else {
    errors.push('Invalid day value used!');
  }
  // End Hours
  if (input.data.endHours >= 0 && input.data.endHours <= 23) {
    data[index++] = input.data.endHours;
  } else {
    errors.push('Invalid hour value used!');
  }
  // End Minutes
  if (input.data.endMinutes >= 0 && input.data.endMinutes <= 59) {
    data[index++] = input.data.endMinutes;
  } else {
    errors.push('Invalid minute value used!');
  }
  // End Seconds
  if (input.data.endSeconds >= 0 && input.data.endSeconds <= 59) {
...
function decodeUplinkLairdMsgTypeTempRH(payload) {
  ...
  if (payload.length == 11) {
    ...
    index++;
    // Options
    nextResult = getBitfieldValue(uplinkOptionsBitfield, true, payload[index++]);
    if (nextResult != -1) {
      options = nextResult;
    } else {
      errors.push('Invalid option type used!');
    ...
    // Humidity
    humidity = twoBytesToFloat(payload.slice(index, index + 2));
    index += 2;
    // Temperature
    temperature = twoBytesToFloat(payload.slice(index, index + 2));
    index += 2;
    // Battery Capacity
    ...
    // Alarm Message Count
    alarmMsgCount = twoBytesToUInt16(payload.slice(index, index + 2));
    index += 2;
    // Backlog Message Count
    backlogMsgCount = twoBytesToUInt16(payload.slice(index, index + 2));
    index += 2;
  } else {
...
function decodeUplinkLairdMsgTypeAggTempRH(payload) {
  ...
  if (payload.length > 11) {
    var readingsBytesLength = payload[6] * 4;
    if (payload.length == readingsBytesLength + 11) {
      ...
      // Timestamp
      timestamp = convertTimestampToDate(payload.slice(index, index + 4));
      index += 4;

      // Size the readings array as per the number of readings in the message
      readings = new Array([payload[6]]);

      for (; readingsBytesLength; readingsBytesLength -= 4) {
        humidity = twoBytesToFloat(payload.slice(index, index + 2));
        index += 2;
        temperature = twoBytesToFloat(payload.slice(index, index + 2));
        index += 2;
...
function decodeUplinkLairdMsgTypeBacklogMessage(payload, isRtd) {
  ...
  if (payload.length == 10) {
    ...
    if (isRtd) {
      // Temperature
      temperature = fourBytesToFloat(payload.slice(index, index + 4));
      index += 4;
    } else {
      // Humidity
      humidity = twoBytesToFloat(payload.slice(index, index + 2));
...
function decodeUplinkLairdMsgSimpleConfig(payload) {
  ...
  if (payload.length == 8) {
    ...
    // Battery Type
    nextResult = getEnumValue(batteryTypeEnum, true, payload[index++]);
    if (nextResult != -1) {
      batteryType = nextResult;
    } else {
      errors.push('Invalid Battery Type used!');
    ...
    // Sensor Read Period
    sensorReadPeriod = twoBytesToUInt16(payload.slice(index, index + 2));
    index += 2;
    // Sensor Aggregate Count
    sensorAggregate = payload[index++];
    // Temp Alarms Enabled
    nextResult = getEnumValue(booleanEnum, true, payload[index++]);
    if (nextResult != -1) {
      tempAlarmsEnabled = nextResult;
    } else {
      errors.push('Invalid Temperature Alarm Enable used!');
...
function decodeUplinkLairdMsgAdvancedConfig(payload) {
  ...
  if (payload.length == 16) {
    ...
    // LED BLE
    ledBle = twoBytesToUInt16(payload.slice(index, index + 2));
    index += 2;
    // LED LoRa
    ledLora = twoBytesToUInt16(payload.slice(index, index + 2));
  } else {
    errors.push('Invalid uplink message length!');
  }
  if (errors.length != 0) {
...
function decodeUplinkLairdMsgTypeFirmwareVersion(payload) {
  ...
  if (payload.length == 11) {
    ...
    // Release Date
    releaseDate = payload[index++].toString() + '/' + payload[index++].toString() + '/' + payload[index++].toString();
    // Release Number
    releaseNumber = payload[index++].toString() + '.' + payload[index++].toString();
    // Part Number
    partNumber = fourBytesToUInt32(payload.slice(index, index + 4));
    index += 4;
  } else {
    errors.push('Invalid uplink message length!');
  }
...
function decodeUplinkLairdMsgTypeContactSensorConfig(payload) {
  ...
  if (payload.length == 10) {
    ...
    // Operating Mode
    nextResult = getEnumValue(operatingModeEnum, true, payload[index++]);
    if (nextResult != -1) {
      operatingMode = nextResult;
    } else {
      errors.push('Invalid Operating Mode used!');
    ...
    // LoRa Notification Options
    nextResult = getBitfieldValue(loraIndicationOptionsBitfield, true, payload[index++]);
    if (nextResult != -1) {
      loraNotificationOptions = nextResult;
    } else {
      errors.push('Invalid option type used!');
    ...
    // Open Dwell Time
    openDwellTime = twoBytesToUInt16(payload.slice(index, index + 2));
    index += 2;
    // Closed Dwell Time
    closedDwellTime = twoBytesToUInt16(payload.slice(index, index + 2));
    index += 2;
    // Resend Interval
...
function decodeUplinkLairdMsgTypeContactSensorState(payload) {
  ...
  if (payload.length == 6) {
    ...
    // Sensor State
    nextResult = getEnumValue(openClosedSensorStateEnum, true, payload[index++]);
    if (nextResult != -1) {
      state = nextResult;
    } else {
...
function decodeUplinkLairdMsgTypeBatteryVoltage(payload) {
  ...
  if (payload.length == 4) {
    ...
    // Voltage
    voltage = twoBytesToFloat(payload.slice(index, index + 2));
    index += 2;
  } else {
    errors.push('Invalid uplink message length!');
  }
...
function decodeUplinkLairdMsgRTDConfig(payload) {
  ...
  if (payload.length == 15) {
    ...
    // Temp Alarm Low Limit
    tempAlarmLimitLow = twoBytesToInt16(payload.slice(index, index + 2));
    index += 2;
    // Temp Alarm High Limit
    tempAlarmLimitHigh = twoBytesToInt16(payload.slice(index, index + 2));
    index += 2;
    // LED BLE
    ledBle = twoBytesToUInt16(payload.slice(index, index + 2));
    index += 2;
...
function decodeUplink(input) {
  ...
  switch (input.bytes[0]) {
    case 0x2:
      output = decodeUplinkLairdMsgTypeAggTempExt(input.bytes);
      break;
    case 0x3:
      output = decodeUplinkLairdMsgTypeBacklogMessage(input.bytes, true);
      break;
    case 0x4:
      output = decodeUplinkLairdMsgTypeBacklogMessages(input.bytes, true);
      break;
    case 0x5:
      output = decodeUplinkLairdMsgSimpleConfig(input.bytes);
      break;
    case 0xc:
      output = decodeUplinkLairdMsgRTDConfig(input.bytes);
      break;
    case 0x7:
    ...
    case 0xa:
      ...
      break;
    case 0xb:
      output = decodeUplinkLairdMsgTypeTempExt(input.bytes);
      break;
    default:
      output.errorsOccurred = 'True';
      output.errors = ['Invalid message type used!'];
