    ...
    switch(COMMAND_ID[commandId])
    {
      ...
      case "COMMANF_ID_GET_STATUS":
        ...
        if( !!(status_param_tx_enable_reg & (1 << 6)) )
        {
          ...
          data.heating_control.room_temperature.value = (input.bytes[idx++] * 0.2).toFixed(1);
        ...
        if( !!(status_param_tx_enable_reg & (1 << 5)) )
        {
          ...
          data.heating_control.set_point_temperature.value = (input.bytes[idx++] * 0.2).toFixed(1);
      ...
      case "COMMAND_ID_GET_HOLIDAY_MODE_CONFIG":
        ...
        data.heating_control.mode.holiday.set_point_temperature.value = (input.bytes[idx++] * 0.2).toFixed(1);
      ...
      case "COMMAND_ID_GET_SET_POINT_TEMPERATURE":
        ...
        data.heating_control.mode.manu_temp.value = (input.bytes[idx++] * 0.2).toFixed(1);
      ...
      case "COMMAND_ID_GET_WINDOW_OPEN_DETECTION_CONFIG":
        ...
        data.heating_control.mode.window_open_detection.config.open_temperature.value = (input.bytes[idx++] * 0.2).toFixed(1);
